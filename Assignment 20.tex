...
\vspace{3cm}
\title{Matrix theory - Assignment 20}
...
\begin{abstract}
This document deals with  ideals of polynomial.
\end{abstract}
Download latex-tikz from
\begin{lstlisting}
https://github.com/satyam463/Assignment-20/blob/main/Assignment%2020.tex
\end{lstlisting}
%
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4]{index set.png}
\caption{Index set containing $\alpha$}
\end{figure}
%\pagebreak
\begin{figure}[h!]
\centering
\includegraphics[width=\columnwidth]{ideal.png}
